...
export default function NewGuideForm() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/content/guide', {
      ...
      body: JSON.stringify({ title, tagline: tagline || undefined, content_kind: 'article' }),
    });
    ...
    router.push(`/learn/creator/guides/${data.item.slug}`);
  }
    ...
    <form onSubmit={submit} className="space-y-4 bg-white rounded-2xl border border-neutral-200 p-6">
      <div>
        ...
        <input
          ...
          placeholder="לדוגמה: 5 טיפים לפרומפטים טובים"
      ...
      <div>
        ...
        <input
          ...
          placeholder="שורה אחת שמופיעה בכרטיס"
