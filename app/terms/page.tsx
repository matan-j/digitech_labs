          ...
          <section className="mt-8 space-y-8 text-neutral-800 leading-[1.7]">
            ...
            <Section title="1. הגדרות">
              <List items={[
                ...
                <><strong>"תוכן"</strong> — קורסים, סרטונים, מדריכים, פלייבוקים, טקסטים, תמונות, וכל חומר אחר שמוצג בפלטפורמה.</>,
              ]} />
            </Section>
            ...
            <Section title="5. קניין רוחני">
              <p>כל הזכויות בתוכן הפלטפורמה — לרבות קורסים, סרטונים, מדריכים, פלייבוקים, טקסטים, גרפיקה, לוגואים, סימני מסחר, קוד המקור, ועיצוב הממשק — שייכות לחברה או למי שהעניק לה רישיון, ומוגנות על-פי דיני זכויות יוצרים והקניין הרוחני בישראל ובעולם.</p>
