          ...
          <section className="mt-8 space-y-8 text-neutral-800 leading-[1.7]">
            ...
            <Section title="2. איזה מידע אנו אוספים">
              ...
              <List items={[
                ...
                <><strong>מידע למידה</strong> — קורסים בהם צפית, מדריכים שקראת, פלייבוקים שהפעלת, התקדמות במודולים והעדפות תוכן.</>,
            ...
            <Section title="3. איך אנחנו משתמשים במידע">
              <List items={[
                'לספק לך גישה לתוכן: קורסים, מדריכים, פלייבוקים, התקדמות אישית.',
